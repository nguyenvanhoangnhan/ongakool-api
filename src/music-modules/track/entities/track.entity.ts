import {
  Album,
  AlbumWithForeign,
} from 'src/music-modules/album/entities/album.entity';
...
import { Artist, ArtistWithForeign } from 'src/artist/entities/artist.entity';
...
export class TrackWithForeign extends Track {
  ...
  @Transform(({ obj }) => PlainToInstance(ArtistWithForeign, obj?.mainArtist))
  mainArtist?: ArtistWithForeign;

  @ApiPropTypeOptional(AlbumWithForeign)
  @Transform(({ obj }) => PlainToInstance(AlbumWithForeign, obj?.album))
  album?: AlbumWithForeign;
